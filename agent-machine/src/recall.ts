...
// CM-1: Brain/episodes = ký ức xuyên phiên (episodic-summary) — PHẢI index để phiên sau recall thấy.
const INDEX_DIRS = ['Context', 'Projects', 'Skills', 'Daily', 'Brain/decisions', 'Brain/entities', 'Brain/claude-memory', 'Brain/episodes']
