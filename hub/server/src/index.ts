...
for (const [route, fwd] of [['/api/am/config', '/config'], ['/api/am/card', '/card'], ['/api/am/card/remove', '/card/remove'], ['/api/am/card/activate', '/card/activate'], ['/api/am/approve', '/approve'], ['/api/am/reject', '/reject'], ['/api/am/project', '/project'], ['/api/am/project/remove', '/project/remove'], ['/api/am/project/trash', '/project/trash'], ['/api/am/project/restore', '/project/restore'], ['/api/am/project/purge', '/project/purge'], ['/api/am/project/channel', '/project/channel'], ['/api/am/channel/post', '/channel/post']] as const) {
